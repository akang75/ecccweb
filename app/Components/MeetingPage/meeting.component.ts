...
export class MeetingComponent extends WebPartBase {
    public churchenglish: TableData;
    public fellowshipenglish: TableData;
    public churchsimplifychinese: TableData;
    public fellowshipsimplifychinese: TableData;
    public churchtraditionalchinese: TableData;
    public fellowshiptraditionalchinese: TableData;
