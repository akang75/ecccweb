...
export class MeetingComponent extends WebPartBase {
    churchenglish: TableData;
    fellowshipenglish: TableData;
    classenglish:TableData;
    churchsimplifychinese: TableData;
    fellowshipsimplifychinese: TableData;
    classsimplifychinese:TableData;
    churchtraditionalchinese: TableData;
    fellowshiptraditionalchinese: TableData;
    classtraditionalchinese:TableData;
